...
[array]$computers = Get-ADComputer -Filter * -Server $dc -Credential $user `
...
[array]$users = Get-ADUser -Filter * -Server $dc -Credential $user `
...
[array]$groups = Get-ADGroup -Filter * -Server $dc -Credential $user `
